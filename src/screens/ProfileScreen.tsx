...
const ProfileScreen = ({ navigation, route }: Props) => {
  const { currentUser, loading, success, message, error } = useAppSelector(
    (state) => state.global
  );
  ...
  const handleSignUpModal = async () => {
    ...
    const emailRegex: RegExp =
      /^[a-zA-Z0-9_\u00C0-\u017F]+@[a-zA-Z0-9_\u00C0-\u017F]+\.[a-zA-Z0-9_\u00C0-\u017F]+$/;
  ...
  return (
    <View className="flex-1 bg-[#FAFAFA]">
      <Animated.View
        className="bg-[#4CAF50] rounded-b-3xl h-1/6 w-full justify-center px-5"
        style={[
      ...
      {/* <Image
						...
						/> */}
      <Animated.View
        className="my-3 rounded-3xl py-3 px-6 flex-1 bg-white"
        style={{
          borderRadius: 16,
          shadowColor: "#000",
          shadowOpacity: 0.1,
      ...
      >
        ...
        >
          ...
          <Text
            ...
            style={{ fontFamily: "Inter", fontSize: 16, color: "#212121" }}
          >
            {t("privacyPolicy")}
          </Text>
        </TouchableOpacity>
        ...
        {!currentUser?.email ? (
          ...
          >
            ...
            <Text
              className="font-semibold text-lg"
              style={{ fontFamily: "Inter", fontSize: 16, color: "#FF6F61" }}
            >
              {t("deleteAccount")}
            </Text>
          </TouchableOpacity>
      ...
      >
        <View style={styles.centeredView}>
          <KeyboardAvoidingView className="flex-1" behavior="padding">
            ...
            >
              <View
                className="w-full gap-y-3 px-5 bg-white rounded-xl py-5"
              ...
              >
                ...
                <View className="items-center gap-y-3 justify-between w-full px-2">
                  ...
                  />
                  <TouchableOpacity
                    className="py-1 w-full justify-center px-1.5 flex-row rounded-full"
      ...
      >
        <View style={styles.centeredView}>
          <View
            className="w-11/12 gap-y-5 px-5 bg-white rounded-xl"
          ...
          >
            <TouchableOpacity
              ...
              onPress={toggleLanguageModal}
            >
              <Text className="font-semibold self-center text-xl">
                {t("changeAppLangugage")}
              </Text>
            ...
            <View className="mt-10 mb-5">
              {Languages.map((lang, index) => (
                <Animated.View
                  entering={FadeInLeft.delay(300 * index + 1)}
                  key={index}
                >
                  <TouchableOpacity
                    key={index}
      ...
      <View className="h-16 flex-row items-center self-center mb-5">
        ...
        >
          <Text className="text-black font-semibold text-sm self-center">
            By Softwarify
          </Text>
        </TouchableOpacity>
